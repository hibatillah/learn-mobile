...
import com.ujian.soaluts.fragments.Taxi
import com.ujian.soaluts.fragments.TiketPesawat
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    lateinit var tiketPesawat: TiketPesawat
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.taxi-> {
                ...
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.frame_layout, taxi)
                    .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                    .commit()
            }
            R.id.pesawat-> {
                ...
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.frame_layout, tiketPesawat)
                    .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                    .commit()
            }
            R.id.Logout-> {
