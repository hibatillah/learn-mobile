...
fun main() {
    ...
    val nilai = 88
    when (nilai) {
        in 1..9 -> println("$nilai bereada diantara angka 1-9")
        in 10..99 -> println("$nilai bereada diantara angka 10-99")
        in 100..999 -> println("$nilai bereada diantara angka 100-999")
